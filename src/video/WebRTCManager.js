...
export class DroneStreamManager {
    ...
    */
    ...
    static doesStreamForDroneExist(droneID){
        return droneID in this.ongoingStreams;
    }
...
class DroneStream {
    ...
    * @param {String} droneID The socket id of the drone to establish a P2P connection to
    * @param {String} streamObj The id of the HTML Video tag to render the result to
    */
    constructor(droneID, streamObj) {
        this.droneID = droneID;
        this.streamObj = document.getElementById(streamObj); // TODO: Error handling if object does not exist?

        this.createPeerConnection();
    }

    sendMessage(message) {
        console.log('Client sending message: ' + message + " to drone ID: " + this.droneID);
        DroneStreamManager.socket.emit("webrtc_msg", this.droneID, message);
    }
